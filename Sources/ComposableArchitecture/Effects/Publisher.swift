...
extension EffectPublisher: ObservableType {
...
extension EffectPublisher {
  ...
  public static func future(
    ...
    withEscapedDependencies { escaped in
      let publisher = Observable<Action>.deferred {
        escaped.yield {
          Single<Action>.create { observer in
  ...
  public static func run(
    ...
    withEscapedDependencies { escaped in
      let publisher = Observable<Action>.create { observer in
        escaped.yield {
          work(observer)
        }
      }
...
extension Observable {
  ...
  public func eraseToEffect<Failure>() -> EffectPublisher<Output, Failure> {
  ...
  public func catchToEffect<T>(
    ...
    self
      ...
      .catch { error in
        Observable<T>.just(transform(.failure(error)))
      }
      .eraseToEffect()
  }
  ...
  public func fireAndForget<NewOutput, NewFailure>(
    ...
    self.flatMap { _ in Observable<NewOutput>.empty() }
    .catch { _ in Observable<NewOutput>.empty() }
    .eraseToEffect()
  }
}
