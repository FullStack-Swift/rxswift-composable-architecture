...
final class ViewStoreTests: BaseTCATestCase {
  ...
  func testEqualityChecks() {
    ...
    viewStore1.publisher.sink { _ in }.disposed(by: cancellables)
    viewStore2.publisher.sink { _ in }.disposed(by: cancellables)
    viewStore3.publisher.sink { _ in }.disposed(by: cancellables)
    viewStore4.publisher.sink { _ in }.disposed(by: cancellables)
    viewStore1.publisher.substate.sink { _ in }.disposed(by: cancellables)
    viewStore2.publisher.substate.sink { _ in }.disposed(by: cancellables)
    viewStore3.publisher.substate.sink { _ in }.disposed(by: cancellables)
    viewStore4.publisher.substate.sink { _ in }.disposed(by: cancellables)
